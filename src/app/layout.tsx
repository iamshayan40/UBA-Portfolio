...
export const metadata: Metadata = {
  ...
  keywords: [
    "Usama Bin Amir", "Digital Marketing Expert", "E-commerce Solutions",
    "Meta Ads Specialist", "Business Growth Strategy", "Dropshipping Expert",
    "Online Business Consultant", "Social Media Marketing", "E-commerce Optimization",
    "Business Development Services", "Global E-commerce Solutions",
    "Professional Marketing Services", "Meta Advertising Expert",
    "E-commerce Success Coach", "Digital Business Strategist",
    "Pakistani Digital Marketer", "E-commerce Consultant Pakistan",
